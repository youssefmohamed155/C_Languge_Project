...
void displayVehicleState(ui16 Engine_state, ui16 AC, ui16 Vehicle_Speed, ui16 current_room_temp, ui16 E_T_C_S, ui16 current_engine_temp) // paasing a data to print for user
{
...
void on_vehicle_engine(void) // (((((
{
    ...
    printf(" - [c] Set the engine temperature\n");
    printf(" - [d] Set the room temperature\n");
    printf(" - [e] Back \n\n");
