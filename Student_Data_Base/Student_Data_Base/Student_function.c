...
//    ui16 nume_id;
//
////    totalstudents = sizeof(add)/sizeof( add[0]);
//
//    printf("Entre the ID Student You Need Delete : ");
//    scanf ("%hu",& nume_id);
//
//    for (ui16 i =0 ; i < totalstudents ; i++)
//    {
//        if ( add[i].ID == nume_id )  // // check /// erro
//        {
//            delete = i ;
//            break;
//
//        }
//        else if (nume_id != add[i].ID )
//        {
//            printf(" Found... \v\n");
//        }
//
...
//
//    // delete of arra
//    for(int i=delete; i<totalstudents-1; i++) {
//    add[i] = add[i+1];
//    }
//
////    add[totalstudents] =add[totalstudents-1];
//    totalstudents --;
//
...
//============================================= [7] function check full ============================ :) Done

// void check_full(struct student add[], ui16 totalstudents)
// {
//     ui16 len;

//     len = 100 - totalstudents; //- length

//     printf(" Student Full : %hu \n", len);
// }
...
// //
// //     printf("Student deleted\n");
// //     free(add);  // Deallocate the memory
// // }

// void delete_student(struct student *add, ui16 num_students)
// {
...
//     struct student *temp = malloc(add, (totalstudents) * sizeof(struct student));
//     if (temp == NULL)
//     {
//         printf("Memory reallocation failed\n");
//         return;
